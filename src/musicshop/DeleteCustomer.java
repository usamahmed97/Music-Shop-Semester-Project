...
public class DeleteCustomer extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Enter Customer ID to Delete:");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(DeleteBox.equals("") )
       {
        ...
        try {
            ...
            int confirm=JOptionPane.showConfirmDialog(null, "Are you sure you want to delete this customer?","Delete", JOptionPane.YES_NO_OPTION);
            if (confirm==0)
            ...
            {
                JOptionPane.showMessageDialog(null, "Sorry that customer does not exist");
